...
- How to be a Data Scientist [(slide)](./bk01_how-to-data-scientist.html)

- [Data Science Tools](./bk02_data-science-tools.html)

- [R vocabulary](./bk03_r-vocabulary.html) 

- [Base R](./bk04_Base-R.html) / [cheatsheet](https://www.rstudio.com/resources/cheatsheets/)

- R 프로그래밍 기초 ( [실습 code](./practice/lecture#1_BaseR.R) )

#### Study 2

- [tidyverse](./practice/Lecture2_tidyverse.pdf)

- [실습 code](./practice/lecture#2_tidyverse.R)
